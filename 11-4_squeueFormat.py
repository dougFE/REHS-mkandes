...
sDate = dt.datetime(2019, 2, 1, 12)  # Start of range
eDate = dt.datetime(2019, 2, 2, 0)  # End of range

# Convert both dates to unix time stamps.
sDate = tStamp(sDate)
eDate = tStamp(eDate)

inputPath = os.path.abspath('ExampleData') + '/' # Location  of Folder

outp = open("testOut.txt", 'w+')  # Output txt file
